...
public class Hangman {
    ...
    static final String[] WORDS = {"человек", "работа", "вопрос", "сторона", "страна", "случай",
            ...
            "решение", "история", "власть", "тысяча", "возможность", "результат", "область",
            "компания", "группа", "развитие", "процесс", "условие", "средство", "начало", "уровень",
            "минута", "качество", "дорога", "действие", "любовь", "общество",
            ...
            "положение", "интерес", "правило", "управление", "мужчина", "партия",
            ...
            "директор", "судьба", "девушка", "очередь", "состав", "количество", "событие",
